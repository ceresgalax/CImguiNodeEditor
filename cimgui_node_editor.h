...
CIMGUI_NODE_EDITOR_EXPORT void axNodeEditor_GetGroupMin(ImVec2* pOut);
CIMGUI_NODE_EDITOR_EXPORT void axNodeEditor_GetGroupMax(ImVec2* pOut);
...
CIMGUI_NODE_EDITOR_EXPORT void axNodeEditor_GetNodePosition(axNodeEditor_NodeId nodeId, ImVec2* pOut);
CIMGUI_NODE_EDITOR_EXPORT void axNodeEditor_GetNodeSize(axNodeEditor_NodeId nodeId, ImVec2* pOut);
...
CIMGUI_NODE_EDITOR_EXPORT void axNodeEditor_GetHoveredNode(axNodeEditor_NodeId* pOut);
CIMGUI_NODE_EDITOR_EXPORT void axNodeEditor_GetHoveredPin(axNodeEditor_PinId* pOut);
CIMGUI_NODE_EDITOR_EXPORT void axNodeEditor_GetHoveredLink(axNodeEditor_LinkId* pOut);
CIMGUI_NODE_EDITOR_EXPORT void axNodeEditor_GetDoubleClickedNode(axNodeEditor_NodeId* pOut);
CIMGUI_NODE_EDITOR_EXPORT void axNodeEditor_GetDoubleClickedPin(axNodeEditor_PinId* pOut);
CIMGUI_NODE_EDITOR_EXPORT void axNodeEditor_GetDoubleClickedLink(axNodeEditor_LinkId* pOut);
...
CIMGUI_NODE_EDITOR_EXPORT void axNodeEditor_GetScreenSize(ImVec2* pOut);
CIMGUI_NODE_EDITOR_EXPORT void axNodeEditor_ScreenToCanvas(const ImVec2* pos, ImVec2* pOut);
CIMGUI_NODE_EDITOR_EXPORT void axNodeEditor_CanvasToScreen(const ImVec2* pos, ImVec2* pOut);
